...
export function StatCard({ title, value, icon, trend, trendUp, delay = 0, onClick }: StatCardProps) {
  ...
  return (
    ...
    >
      <Tag
        onClick={onClick}
        className={[
          "stat-card group hover:border-primary/40 transition-colors duration-200 w-full text-right",
