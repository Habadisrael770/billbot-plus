  ...
  return (
    ...
    >
      <button
        ...
        title={locked ? 'חזרה על סצנה: פעיל' : 'חזרה על סצנה: כבוי'}
        aria-label={locked ? 'חזרה על סצנה: פעיל' : 'חזרה על סצנה: כבוי'}
        aria-pressed={locked}
      >
      ...
      <button
        ...
        title={collapsed ? 'הצג פקדים' : 'הסתר פקדים'}
        aria-label={collapsed ? 'הצג פקדים' : 'הסתר פקדים'}
